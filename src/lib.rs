...
mod slai {
    ...
    use super::ffi::{
        ...
        PyEffectCombatEscape, PyEffectCombatStart, PyEffectDamageFinisher, PyEffectDamageFlechettes,
...
PyEffectGamble,
        ...
        PyEffectHeelHookProc, PyEffectLiquidMemoriesPick, PyEffectMaxHealthDelta, PyEffectModifierGain,
