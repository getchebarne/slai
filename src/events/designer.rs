...
const OPT_ADJ_ONE_BASE: Entity =
    make_entity_event_option("[Adjustments] Lose 40 Gold. Upgrade a card.", &ADJ_ONE_BASE);
const OPT_ADJ_TWO_BASE: Entity = make_entity_event_option(
    "[Adjustments] Lose 40 Gold. Upgrade 2 random cards.",
    &ADJ_TWO_BASE,
);
const OPT_CLEAN_REMOVE_BASE: Entity = make_entity_event_option(
    "[Clean Up] Lose 60 Gold. Remove a card from your deck.",
    &CLEAN_REMOVE_BASE,
);
const OPT_CLEAN_TRANSFORM_BASE: Entity = make_entity_event_option(
    "[Clean Up] Lose 60 Gold. Transform 2 cards.",
    &CLEAN_TRANSFORM_BASE,
);
const OPT_FULL_BASE: Entity = make_entity_event_option(
    "[Full Service] Lose 90 Gold. Remove a card, then upgrade a random card.",
    &FULL_BASE,
);
const OPT_PUNCH_BASE: Entity = make_entity_event_option("[Punch] Lose 3 HP.", &PUNCH_BASE);
const OPT_ADJ_ONE_A15: Entity =
    make_entity_event_option("[Adjustments] Lose 50 Gold. Upgrade a card.", &ADJ_ONE_A15);
const OPT_ADJ_TWO_A15: Entity = make_entity_event_option(
    "[Adjustments] Lose 50 Gold. Upgrade 2 random cards.",
    &ADJ_TWO_A15,
);
const OPT_CLEAN_REMOVE_A15: Entity = make_entity_event_option(
    "[Clean Up] Lose 75 Gold. Remove a card from your deck.",
    &CLEAN_REMOVE_A15,
);
const OPT_CLEAN_TRANSFORM_A15: Entity = make_entity_event_option(
    "[Clean Up] Lose 75 Gold. Transform 2 cards.",
    &CLEAN_TRANSFORM_A15,
);
const OPT_FULL_A15: Entity = make_entity_event_option(
    "[Full Service] Lose 110 Gold. Remove a card, then upgrade a random card.",
    &FULL_A15,
);
const OPT_PUNCH_A15: Entity = make_entity_event_option("[Punch] Lose 5 HP.", &PUNCH_A15);
